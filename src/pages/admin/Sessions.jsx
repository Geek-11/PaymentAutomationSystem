...
//     try {
//       if (currentSession) {
//         console.log('editing mode', currentSession);
//         const sessionRef = await setDoc(doc(db, 'sessions', currentSession.id), session);
//         // await updateDoc(sessionRef, session);
//         setSessions(sessions.map(s => s.id === session.id ? session : s));
//         toast.success('Session updated successfully');
//       } else {
//         console.log("if new session", session);
...
//         // const payoutRef = doc(db, "payouts", );
...
//         //   if (sessions.includes("yourSessionId")) {
...
//         let payout = payouts.find(p => {
//           const sessionExists = p.sessions.includes(session.id);
//           return sessionExists;
//         });
//         console.log(payout);
//         if(payout){
//           console.log('old payout edit', payout);
...
//                                      });
//         } else{
//           console.log('new payout creation', payout);
//           payout = {
//             status: 'Pending',
